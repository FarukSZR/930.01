...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/930.01_v45K22.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=fs_adc.c fs_eeprom.c fs_lcd.c fs_main.c fs_mcu.c fs_menu_controller.c fs_pwm.c fs_speed_controller.c fs_timer.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/fs_adc.p1 ${OBJECTDIR}/fs_eeprom.p1 ${OBJECTDIR}/fs_lcd.p1 ${OBJECTDIR}/fs_main.p1 ${OBJECTDIR}/fs_mcu.p1 ${OBJECTDIR}/fs_menu_controller.p1 ${OBJECTDIR}/fs_pwm.p1 ${OBJECTDIR}/fs_speed_controller.p1 ${OBJECTDIR}/fs_timer.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/fs_adc.p1.d ${OBJECTDIR}/fs_eeprom.p1.d ${OBJECTDIR}/fs_lcd.p1.d ${OBJECTDIR}/fs_main.p1.d ${OBJECTDIR}/fs_mcu.p1.d ${OBJECTDIR}/fs_menu_controller.p1.d ${OBJECTDIR}/fs_pwm.p1.d ${OBJECTDIR}/fs_speed_controller.p1.d ${OBJECTDIR}/fs_timer.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/fs_adc.p1 ${OBJECTDIR}/fs_eeprom.p1 ${OBJECTDIR}/fs_lcd.p1 ${OBJECTDIR}/fs_main.p1 ${OBJECTDIR}/fs_mcu.p1 ${OBJECTDIR}/fs_menu_controller.p1 ${OBJECTDIR}/fs_pwm.p1 ${OBJECTDIR}/fs_speed_controller.p1 ${OBJECTDIR}/fs_timer.p1

# Source Files
SOURCEFILES=fs_adc.c fs_eeprom.c fs_lcd.c fs_main.c fs_mcu.c fs_menu_controller.c fs_pwm.c fs_speed_controller.c fs_timer.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/930.01_v45K22.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/930.01_v45K22.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/930.01_v45K22.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/930.01_v45K22.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/930.01_v45K22.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/930.01_v45K22.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/930.01_v45K22.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/930.01_v45K22.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
